...
void limpaPalavra(palavraRegistrada ponteiro[], int n)
{
    for (int i = 0; i < n; i++)
    {
        //cout<< primeiraLetra<< "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!";
        switch (ponteiro[i].palavra[0])
        {
            //cout<< ponteiro[i].palavra[0]<< "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!";
        case 'a':
        //case 'á':
        case 'A':
        //case 'Á':
            // cout<< primeiraLetra<< "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!";
            ponteiro[i].palavra[0] = 'A';
           // cout << ponteiro[i].palavra << "\n\n";
            break;
...
int main()
{
    ...
    do
    {
        ...
        case 8:
            for (int i = 0; i < n; i++)
            {
                if (ponteiro[i].palavra[0] == 'A')
                {
                    cout << ponteiro[i].palavra << endl;
                }
            }
            break;
        default:
